...
CREATE TABLE IF NOT EXISTS skater_profiles (
    ...
    avatar_border_style TEXT NOT NULL DEFAULT '',  -- off, default, custom, pulse, strobe, fire, neon, orbit
